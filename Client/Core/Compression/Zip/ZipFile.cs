...
using System.Text;
using xClient.Core.Compression.Zip.Checksums;
using xClient.Core.Compression.Zip.Compression;
using xClient.Core.Compression.Zip.Compression.Streams;
using xClient.Core.Compression.Zip.Core;
using xClient.Core.Compression.Zip.Encryption;
#if !NETCF_1_0
#endif

namespace xClient.Core.Compression.Zip 
{
