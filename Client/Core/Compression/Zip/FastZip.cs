...
namespace xClient.Core.Compression.Zip
{
	...
	public class FastZip
	{
			...
			bool recurse, string fileFilter, string directoryFilter)
		{
            ...
            CreateZip(File.Create(zipFileName), sourceDirectory, recurse, fileFilter, directoryFilter, out zipOut);
            zipOut.Close();
            zipOut.Dispose();
        }
		...
		{
		    ZipOutputStream zipOut;
			CreateZip(File.Create(zipFileName), sourceDirectory, recurse, fileFilter, null, out zipOut);
		    zipOut.Close();
		    zipOut.Dispose();
		}
